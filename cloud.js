...
function Clouder(params) {
	...
	function setupElems(elems) {
		for (var e in elems) {
			//console.log('test=', elems[e]);
			//console.log(circle[e].id);
			var c = {};
			c.text = elems[e].id;
			c.id = elems[e].id;
			c.weight = 1;
    ...
    function draw() {
        ...
        process(function(o) {
            ...
            o.span.style.fontSize = (Math.round(size)/7) +'em';
			//console.log(size);
            o.span.style.fontSize = Math.round(size);

			o.span.style.width = Math.round(size)+10;
			o.span.style.height = Math.round(size)+10;
